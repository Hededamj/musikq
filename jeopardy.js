...
const JEOPARDY_CATEGORIES = [
  ...
  {
    name: "Palles kategori",
    icon: "🎛️",
    questions: [
      { points: 100, q: "Hvem sang 'Beat It' og 'Thriller' i 1982?", a: "Michael Jackson", options: ["Michael Jackson", "Prince", "Lionel Richie", "Stevie Wonder"] },
      { points: 200, q: "Hvilket britisk synth-pop-band sang 'Don't You Want Me' i 1981?", a: "The Human League", options: ["The Human League", "Soft Cell", "Heaven 17", "Yazoo"] },
      { points: 300, q: "Hvem sang 'Take My Breath Away' fra Top Gun-soundtracket?", a: "Berlin", options: ["Berlin", "Heart", "Pat Benatar", "Survivor"] },
